...
<Step title="引入实时音视频">
在插件市场购买 [ZEGO 即构实时音视频 SDK](https://ext.dcloud.net.cn/plugin?id=3617)。购买时填入的 AppID 必须和后面需要运行的 AppID 一致。
...
<Frame height="120px">
    <img src="https://media-resource.spreading.io/docuo/workspace733/92cf2c578a7f03194465a905bb923c76/9276069cc7.png" alt="screenshot-20240909-101238.png"/>
</Frame>
</Step>
