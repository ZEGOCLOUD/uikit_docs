...
如果您需要在音频模式下自定义用户的视图，例如设置背景图片或背景颜色，您可以使用 `ZegoLayoutPictureInPictureConfig` 中的 `largeViewBackgroundImage`、`smallViewBackgroundImage`、`largeViewBackgroundColor`、`smallViewBackgroundColor`。
