...
<Note title="TIPS">If you need the call invitation feature, the integration method is different. Please refer to [this document](./03-Quick%20start%20(with%20call%20invitation).mdx).</Note>
