...
```
注意：如果你的应用需要上传到 Google Play Store，由于 [Google Play Store 的政策](https://support.google.com/googleplay/android-developer/answer/13392821?hl=zh),你可能需要针对这两个权限作出相应的声明才可以避免被拒绝。
