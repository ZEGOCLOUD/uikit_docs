...
这份文档将指导您如何在 uni-app 项目集成`音视频通话 UIKit`小程序 SDK 并快速开始音视频通话。如果您还没有 uni-app 项目，请参考 [uni-app 文档](https://zh.uniapp.dcloud.io/quickstart-hx.html)创建。
...
|                                                                                                                                                                                                          |                                                                                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Frame width="256" height="auto" caption=""><img src="http://media-resource.spreading.io/docuo/workspace564/27e54a759d23575969552654cb45bf89/12765df983.jpeg" alt="miniprogram_your_page.jpeg"/></Frame> | <Frame width="256" height="auto" caption=""><img src="http://media-resource.spreading.io/docuo/workspace564/27e54a759d23575969552654cb45bf89/efee65a3e8.jpeg" alt="miniprogram_single_call_page.jpeg"/></Frame> |
