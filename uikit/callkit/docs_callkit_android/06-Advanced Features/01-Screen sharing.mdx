...
To implement screen sharing functionality, please add the following permissions to your app module's manifest file:
```xml
<uses-permission android:name="android.permission.FOREGROUND_SERVICE" />
<uses-permission android:name="android.permission.FOREGROUND_SERVICE_MEDIA_PROJECTION" />
```

Note: If your app needs to upload you app to Google Play Store, due to [Google Play Store's policy](https://support.google.com/googleplay/android-developer/answer/13392821?hl=en), you may need to make corresponding declarations for these two permissions to avoid rejection.
