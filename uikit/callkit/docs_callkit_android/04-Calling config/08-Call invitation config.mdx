...
When using the call invitation feature, you can customize the configuration of ZegoUIKitPrebuiltCallConfig by setting ZegoUIKitPrebuiltCallConfigProvider. The code reference is as follows:
...
## Customizing Call Configuration
...
<CodeGroup>
```java title="Customizing Call Configuration"
public class MainActivity extends AppCompatActivity {
    long appID = YourAppID;
    String appSign = YourAppSign;
    String userID = "userID";
    ...
    public void initCallInviteService() {
        ...
        public ZegoUIKitPrebuiltCallConfig requireConfig(ZegoCallInvitationData invitationData) {
              ZegoUIKitPrebuiltCallConfig config = ZegoUIKitPrebuiltCallInvitationConfig.generateDefaultConfig(
                    invitationData);
            // Modify the config settings here according to your business requirements.
        }
    }
}
```
