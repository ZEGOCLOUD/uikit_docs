...
| callingConfig                       | Configurations related to inviting users to an ongoing call.       | [ZegoCallInvitationInCallingConfig](#ZegoCallInvitationInCallingConfig)                                                          |
...
| Property                   | Description                   | type                                  |
| ---------------------- | ---------------------- | ------------------------------------- |
| canInvitingInCalling   |     Whether to enable inviting users to an ongoing call          | boolean  |
| onlyInitiatorCanInvite | Only the person who initiated the call can invite others to join | boolean  |
