...
| callingConfig                | calling invite feature configure                                                                                                                                       | ZegoCallInvitationInCallingConfig                                                          |
| endCallWhenInitiatorLeave                | Whether to End the Call When the Initiator Leaves                                                                                                                                        | boolean                                           |
