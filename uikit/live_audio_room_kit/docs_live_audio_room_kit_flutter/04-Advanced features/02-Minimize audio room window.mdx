# Minimize audio room window(Overlay)
...
we will enable PIP by default, which means **enableWhenBackground** default value is true. If you don't want to enable it, you can modify it to false through **ZegoLiveAudioRoomPIPConfig**. 

In addition, if you want to control it through buttons, you can add **ZegoLiveAudioRoomMenuBarButtonName.pipButton** in **topMenuBar.buttons**.
