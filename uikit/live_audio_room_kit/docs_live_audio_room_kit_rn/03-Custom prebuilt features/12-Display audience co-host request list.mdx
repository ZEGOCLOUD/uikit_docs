...
The `CohostRequestList` component is not included in Live Audio Room Kit. You can find it on this [GitHub repository](https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_live_audio_room_rn/blob/master/example/src/CohostRequestList.tsx), copy it into the "./src" directory of your project, and if you want, adjust the display style.
...
<Step title="Create a Ref const">
Create a `cohostRequestListRef` const, which will be used to call interfaces of the CohostRequestList component.
</Step>
