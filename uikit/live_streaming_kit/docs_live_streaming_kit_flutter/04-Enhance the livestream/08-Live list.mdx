...
<Steps>
  <Step title="Define a ZegoLiveStreamingOutsideLiveListController">
    You need to associate the `controller` to `ZegoUIKitPrebuiltLiveStreaming` on `step 3`.
  ...
  <Step title="Add ZegoLiveStreamingOutsideLiveList on your widget">
    Add this list widget on the view you need to display
  ...
  <Step title="Connect ZegoLiveStreamingOutsideLiveListController to ZegoUIKitPrebuiltLiveStreaming">
    Associate the `controller` declared on `step 1 `to `ZegoUIKitPrebuiltLiveStreaming`
  ...
  <Step title="Update the LIVE room list to be displayed">
    You can update hosts at any time.
