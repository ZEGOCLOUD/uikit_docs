...
<Frame width="50%" height="auto" caption="">
    <img src="https://media-resource.spreading.io/docuo/workspace564/27e54a759d23575969552654cb45bf89/8f6dea1eea.gif" alt="ezgif-5-48b96c2012.gif"/>
</Frame>
...
you need assign the **controller of ZegoLiveStreamingOutsideLiveList** to **controller of ZegoLiveStreamingOutsideLiveConfig**, which is **config.outsideLive.controller in ZegoUIKitPrebuiltLiveStreaming**
</Note>
            ...
            MaterialPageRoute(
              builder: (context) => SafeArea(
                child: ZegoUIKitPrebuiltLiveStreaming(
                  ...
                  ..outsideLive.controller = liveListController,
                ),
              ),
            ),
          );
