...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // The production environment `isSandboxEnvironment` is set to false
...
<CardGroup cols={2}>
  ...
  <Card title="Call Kit - Quick start" href="https://www.zegocloud.com/docs/uikit/callkit-ios/quick-start-(with-call-invitation)</Card>
