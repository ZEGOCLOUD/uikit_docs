...
* To implement a basic call swiftly, follow the steps: [QUICK START (basic call)](https://www.zegocloud.com/docs/uikit/callkit-flutter/quick-start)
* To implement a call with call invitation, follow the steps: [QUICK START (with call invitation)](https://www.zegocloud.com/docs/uikit/callkit-flutter/quick-start-(with-call-invitation))
* I want to get the Sample Code: [SAMPLE CODE](https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_call_example_flutter)
