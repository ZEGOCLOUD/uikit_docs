...
</li><li>If the message fails to be sent to all users, the Code will return the corresponding return code. Please refer to <a href="!zim-Server_APIs/Return_Codes">Return Codes</a>. </li></ul></div></td>
</tr>
<tr data-row-level="3">
<td>Message</td>
<td>String</td>
