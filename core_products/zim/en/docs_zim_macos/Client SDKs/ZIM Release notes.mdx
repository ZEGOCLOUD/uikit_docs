...
| User online status | Users can continuously monitor the online status changes of other users by subscription, query the current online statuses of other users, and also query their own subscription list. In addition, in the scenario of multi-device login, users can listen for changes in their online platforms. For more details, please refer to [Online Status Subscription](./../Guides/Users/Online%20Status%20Subscription.mdx).| <ul><li>[subscribeUsersStatus](@subscribeUsersStatus)</li><li>[userStatusUpdated](https://www.zegocloud.com/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-user-status-updated)</li><li>[unsubscribeUsersStatus](@unsubscribeUsersStatus)</li><li>[queryUsersStatusByUserIDs](@queryUsersStatusByUserIDs)</li><li>[querySubscribedUserStatusListWithConfig](@querySubscribedUserStatusListWithConfig)</li></ul> |
