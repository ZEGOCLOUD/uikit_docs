...
| -----  | ---- | ----- |
| Deprecated System Message Type | The system message (value 30) has been deprecated. Developers are advised to use the more feature-rich custom message (value 200) instead. | [ZIMMessageTypeCustom](https://www.zegocloud.com/article/apidoc=zim_API~cs_unity3d~enum~ZIMMessageType#custom) |
