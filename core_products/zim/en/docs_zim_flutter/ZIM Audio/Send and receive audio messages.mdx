...
To implement more features, pass in a license. For more information about how to obtain a license, see [Implement online authentication](./../../docs_zim_android/ZIM%20Audio/Implement%20online%20authentication.mdx).
