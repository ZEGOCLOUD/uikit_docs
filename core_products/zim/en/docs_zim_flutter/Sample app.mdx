...
Get the <a href="https://github.com/zegoim/zim_flutter_sdk/tree/main/example" target="_blank">sample code package</a>. The following structure shows the subdirectory structure of the sample code:
