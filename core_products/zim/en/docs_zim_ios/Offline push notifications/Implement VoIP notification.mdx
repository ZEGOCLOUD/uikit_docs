...
<Step title="Apply for Notification Permission">
Call the [applyNotificationPermission](https://doc-en.zego.im/article/api?doc=zim_API~javascript_react-native~class~ZPNs#apply-notification-permission) method to request the user's consent for the app's notification permission.
