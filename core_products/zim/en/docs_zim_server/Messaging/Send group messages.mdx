...
The following table describes only the return codes related to the business logic of the operation. For the complete list of return codes, see <a href="https://doc-preview-en.zego.im/article/14024" target="_blank" rel="noopener">Return codes</a>.
