...
export const enableFCMPush={
    "Android": <a href="@enableFCMPush" target="_blank">enableFCMPush</a>,
    "Flutter": <a href="https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNsConfig/enableFCMPush.html" target="_blank">enableFCMPush</a>,
}
export const setPushConfig={
    "Android": <a href="@setPushConfig" target="_blank">setPushConfig</a>,
    "Flutter": <a href="https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNs/setPushConfig.html" target="_blank">setPushConfig</a>,
}
