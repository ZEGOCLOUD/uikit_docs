...
- Sample code:
    ...
    try{
        ...
        // Room switch successful, you can obtain information about the switched room from result.roomInfo.
    } on PlatformException catch (onError){
        onError.code; // Error code for failed room switch
        onError.message; // Error message for failed room switch
    }
    ```
    :::
