...
export const onCallUserStateChangedMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-user-state-changed-call-id' target='_blank'>callUserStateChanged</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-user-state-changed-call-id' target='_blank'>callUserStateChanged</a>,
...
export const onCallInvitationCreatedMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-created-call-id' target='_blank'>callInvitationCreated</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-invitation-created-call-id' target='_blank'>callInvitationCreated</a>,
...
export const onCallInvitationReceivedMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-received-call-id' target='_blank'>callInvitationReceived</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-invitation-received-call-id' target='_blank'>callInvitationReceived</a>,
...
export const callInvitationCancelledMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-cancelled-call-id' target='_blank'>callInvitationCancelled</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-invitation-cancelled-call-id' target='_blank'>callInvitationCancelled</a>,
...
export const onCallInvitationTimeoutMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-timeout' target='_blank'>callInvitationTimeout</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-invitation-timeout' target='_blank'>callInvitationTimeout</a>,
...
export const callInvitationEndedMap = {
  ...
  'iOS': <a href='/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-ended-call-id' target='_blank'>callInvitationEnded</a>,
  'mac': <a href='/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-call-invitation-ended-call-id' target='_blank'>callInvitationEnded</a>,
...
Before you use the call invitation feature, make sure that the following prerequisites are satisfied:
...
- (Optional) The offline push certificate of ZIM is configured in the [ZEGO console](https://console.zego.im). You need to configure the certificate when you want to send a call invitation to an offline user and push offline notifications. For more information about how to configure the certificate, see [Offline push configuration](#16233). If you fail to configure the certificate, contact ZEGO technical support.
...
Please refer to <a href="#onCallUserStateChanged">listen to the state changes of call invitation users</a> for more information.
</Note>
