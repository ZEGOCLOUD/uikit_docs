...
export const updateGroupAliasMap = {
  ...
  'Web': <a href='@updateGroupAlias' target='_blank'>updateGroupAlias</a>,
...
export const onGroupAliasUpdatedMap = {
  ...
  'Web': <a href='@groupAliasUpdated' target='_blank'>groupAliasUpdated</a>,
...
try{
    ...
    onError.code; // Failed to modify the group alias, error code
    onError.message; // Error message for modifying the group alias
}
```
</CodeGroup>
:::
