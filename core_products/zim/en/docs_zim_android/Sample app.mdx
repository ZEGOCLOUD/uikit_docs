...
Download the [sample code package](https://storage.zego.im/zim/example/android/ZIMExampleJava.zip) and extract it. The following structure shows the subdirectory structure of the sample code:
