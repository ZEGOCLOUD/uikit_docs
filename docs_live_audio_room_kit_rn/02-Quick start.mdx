...
<CodeGroup>
```bash yarn
yarn add react-delegate-component zego-express-engine-reactnative@3.2.0 zego-zim-react-native@2.7.1 @zegocloud/zego-uikit-rn
```

```bash npm
npm install react-delegate-component zego-express-engine-reactnative@3.2.0 zego-zim-react-native@2.7.1 @zegocloud/zego-uikit-rn
```
</CodeGroup>
