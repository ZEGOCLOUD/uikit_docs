...
<CardGroup cols={2}>
  <Card title="I want to code online and check it in action:">
    ...
    I want to try a live demo (call without invitation)
	  ...
	  <Button primary-color="NavyBlue" target="_self" href="https://zegocloud.github.io/zego_uikit_prebuilt_web/1on1_call/index.html">LIVE DEMO (without invitation)</Button>
  </Card>
