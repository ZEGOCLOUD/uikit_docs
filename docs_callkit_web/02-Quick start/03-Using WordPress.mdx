...
Then, replace the `appID` and `serverSecret` parameters in the following code with your project's AppID and ServerSecret that you get from [Admin Console\|_bblank](https://console.zegocloud.com/project). 
