...
For example, when you want to add a "Start a call" button on the upper right of the message list (`ZIMKitMessageActivity`). To learn more details, see <a href="../04-Advanced%20features/01-Use%20in%20conjunction%20with%20Call%20Kit.mdx">Use with the Call Kit</a>.
