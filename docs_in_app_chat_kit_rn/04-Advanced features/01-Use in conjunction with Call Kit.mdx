...
This doc will introduce how to use In-app Chat Kit with [Call Kit](https://docs.zegocloud.com/article/14764). 
...
<CodeGroup>
```bash yarn
yarn add @zegocloud/zego-uikit-rn react-delegate-component @react-navigation/native @react-navigation/native-stack react-native-screens react-native-safe-area-context react-native-sound @notifee/react-native@5.3.0 zego-express-engine-reactnative@3.2.0 zego-zim-react-native@2.7.1 zego-zpns-react-native@2.3.5 react-native-callkeep
```
```bash npm
npm install @zegocloud/zego-uikit-rn react-delegate-component @react-navigation/native @react-navigation/native-stack react-native-screens react-native-safe-area-context react-native-sound @notifee/react-native@5.3.0 zego-express-engine-reactnative@3.2.0 zego-zim-react-native@2.7.1 zego-zpns-react-native@2.3.5 react-native-callkeep
```
</CodeGroup>

3. Config the `react-native-callkeep` package.

If your react-native version is below 0.60, you need to run the following command in your project root directory to ensure that the `react-native-callkeep` package can work properly.
...
<CardGroup cols={2}>
  ...
  <Card title="Call Kit - Quick start" href="https://zegocloud.com/docs/uikit/call-kit-rn/quick-start" target="_blank">
    Steps in this doc helps you to make a call quickly.
  </Card>

  <Card title="Call Kit - Custom prebuilt UI" href="https://zegocloud.com/docs/uikit/call-kit-rn/calling-config/overview" target="_blank">
