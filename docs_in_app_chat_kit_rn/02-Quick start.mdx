...
<CodeGroup>
```bash yarn
yarn add zego-zim-react-native@2.6.0 react-delegate-component @react-navigation/native @react-navigation/native-stack react-native-screens react-native-safe-area-context
```
```bash npm
npm install zego-zim-react-native@2.6.0 react-delegate-component react-delegate-component @react-navigation/native @react-navigation/native-stack react-native-screens react-native-safe-area-context
```
</CodeGroup>
