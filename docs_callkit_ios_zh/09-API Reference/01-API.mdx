...
-  [ZegoUIKitPrebuiltCallInvitationService](#zegouikitprebuiltcallinvitationservice)
  -  [initWithAppID](#initwithappid)
  -  [unInit](#uninit)
  -  [getPrebuiltCallVC](#getprebuiltcallvc)
  -  [setRemoteNotificationsDeviceToken](#setremotenotificationsdevicetoken)
  -  [endCall](#endcall)
-  [ZegoUIKitPrebuiltCallVC](#zegouikitprebuiltcallvc)
  -  [addButtonToBottomMenuBar](#addbuttontobottommenubar)
  -  [addButtonToTopMenuBar](#addbuttontotopmenubar)
  -  [finish](#finish)
