...
- [CallEvents](#callevents)
    ...
    - [onCallEnd](#oncallend)
    - [ZegoMenuBarButtonClickListener](#zegomenubarbuttonclicklistener)
...
### ZegoMenuBarButtonClickListener
...
## onError
 ...
 this callback will be invoked when SDK error.For example.if SDK init error,INIT_PARAM_ERROR will be
 throwed .
