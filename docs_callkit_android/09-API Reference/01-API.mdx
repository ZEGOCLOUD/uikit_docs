...
### minimizeCall
 ...
 This function is used to minimize the current call.usually it can be used with backpressed Listener to miminimize call when press back button.To make it work,you should have Overlays 
 permission and has ZegoMenuBarButtonName.MINIMIZING_BUTTON and use ZEGO call invite service.
