...
- Follow the integration steps by referring to the [Quick start](/docs_callkit_android/02-Quick start.mdx) or [Quick start with co-hosting](#14882).
- **Contact ZEGOCLOUD Technical Support to activate the advanced beauty effects**.
- Download the [demo](https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_call_effects_demo_android) here.
