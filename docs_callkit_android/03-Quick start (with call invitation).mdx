...
2. Appear on top / Display pop-up window:
...
> In the create resource ID popup dialog, switch to Data messages for FCM.
...
If your project has already integrated Firebase Cloud Messaging, you will need additional steps to complete the integration. Please refer to the [FAQ](#16750) for compatibility issues with Firebase.
...
<CardGroup cols={2}>
  ...
  <Card title="How to upgrade UIKits with a plugin to V2.0.0"  href="https://docs.zegocloud.com/faq/UIKit_Plugin2.0_upgrade?product=UIKits_CallKit&platform=android">
  </Card>
</CardGroup>

## Resources

<Card title="Sample code" href="https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_call_example_android">
