...
<CardGroup cols={2}>
  <Card title="Using HTML script (JQuery, PHP, JSP)" href="/article/14960">
  Implement a call using HTML script
</Card>
<Card title="Using NPM package manager (React, Vue, Angular)" href="/article/14959">
  Implement a call using NPM package manager
</Card>
<Card title="Using WordPress" href="!Using_WordPress">
