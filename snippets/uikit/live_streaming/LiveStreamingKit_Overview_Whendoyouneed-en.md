...
To finest-grained build a live stream app, you may try our [Live Streaming SDK](https://www.zegocloud.com/docs/live-streaming/overview?platform=android&language=java) to make full customization.
