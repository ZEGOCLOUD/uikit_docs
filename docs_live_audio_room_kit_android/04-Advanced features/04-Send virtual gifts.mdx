...
Before you begin, make sure you complete the integration by referring to the [Quick start with co-hosting](https://www.zegocloud.com/docs/uikit/live-streaming-kit-android/quick-start/quick-start-with-cohosting).
