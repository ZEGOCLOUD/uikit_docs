...
- If your Android Gradle Plugin is **7.1.0 or later**: enter your project's root directory, open the `settings.gradle` file to add the jitpack to `dependencyResolutionManagement` > `repositories` like this:
  ...
  For more details, see [Android Gradle Plugin Release Note v7.1.0\|_blank](https://developer.android.com/studio/releases/gradle-plugin#settings-gradle).
  </Warning>
...
<CardGroup cols={1}>
  <Card title="Sample code" href="https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_live_audio_room_example_android">
