...
Before you begin, make sure you complete the integration by referring to the [Quick start with co-hosting](/live-streaming-kit-rn/quick-start/quick-start-(with-cohosting)).
