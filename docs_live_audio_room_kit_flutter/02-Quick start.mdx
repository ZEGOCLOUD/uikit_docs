...
<CardGroup cols={2}>
  <Card title="Sample code" href="https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_live_audio_room_example_flutter">
    Click here to get the complete sample code.
  </Card>
  <Card title="API reference" href="https://pub.dev/documentation/zego_uikit_prebuilt_live_audio_room/latest/zego_uikit_prebuilt_live_audio_room/zego_uikit_prebuilt_live_audio_room-library.html">
