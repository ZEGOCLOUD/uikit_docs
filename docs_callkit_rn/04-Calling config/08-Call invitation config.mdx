...
## Call End Event
If you want to receive relevant callbacks when a call ends, you use `onCallEnd` to listen for the callback when the call ends.
...
2 - the call ended due to being kicked out or room ended.
