import UIKitInvitationPrerequisitesZIMSignaling from "/snippets/Reuse/UIKit_Invitation_Prerequisites_ZIMSignaling-en.md";
...
| config.requireConfig             | Function | No       | This method is called when you receive a call invitation. You can control the SDK behaviors by returning the required config based on the data parameter. For more details, see [Custom prebuilt UI](!ZEGOUIKIT_Custom_prebuilt_UI). |
...
| config.innerText                 | Object   | No       | To modify the UI text, use this property. For more details, see [Custom prebuilt UI](!ZEGOUIKIT_Custom_prebuilt_UI).                                                                                                                 |
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZegoUIKit/RN/PrebuiltCall/android_config.gif" /></Frame>
...
2. Add a `service` tag with the property `android:name="io.wazo.callkeep.VoiceConnectionService` inside the `application` tag and add the following permissions.
...
|                                                                                                                                                                         |                                                                                                                                                                         |                                                                                                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Frame width="256" height="auto" caption=""><img src="https://media-resource.spreading.io/5fa3f99cda659c8c9f2907cbb0242e6c/workspace86/miui12_settings1.jpg" /></Frame> | <Frame width="256" height="auto" caption=""><img src="https://media-resource.spreading.io/5fa3f99cda659c8c9f2907cbb0242e6c/workspace86/miui12_settings2.jpg" /></Frame> | <Frame width="256" height="auto" caption=""><img src="https://media-resource.spreading.io/5fa3f99cda659c8c9f2907cbb0242e6c/workspace86/miui12_settings3.jpg" /></Frame> |
