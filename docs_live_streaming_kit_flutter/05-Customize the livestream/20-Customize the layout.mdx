...
We support PIP (Picture-in-Picture) and Gallery layouts. You can achieve your desired layout by setting the `config.layout` parameter.
...
- Four players are in the four corners of the game
...
- players are arranged vertically in the upper left corner
...
- Players are arranged horizontally at the top
