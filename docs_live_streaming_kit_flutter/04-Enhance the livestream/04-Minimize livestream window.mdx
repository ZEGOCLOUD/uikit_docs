...
#### 1.1.1 Display the minimize button
...
#### 1.1.2 Use ZegoUIKitPrebuiltLiveStreamingController's minimize.toMinimize()
...
### 1.3 Prevent building multiple ZegoUIKitPrebuiltLiveStreaming
