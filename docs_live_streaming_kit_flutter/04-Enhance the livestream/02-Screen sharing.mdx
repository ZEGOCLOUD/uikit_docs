...
Before you begin, make sure you complete the follow the integration steps by referring to the [Quick start](/live-streaming-kit-flutter/quick-start/quick-start) or [Quick start with co-hosting](/live-streaming-kit-flutter/quick-start/quick-start-(with-cohosting)).
