...
- Follow the integration steps by referring to the [Quick start with co-hosting](/live-streaming-kit-flutter/quick-start/quick-start-(with-cohosting)).
...
|-|-|
| [onOutgoingRequestAccepted](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestAccepted.html) | The PK invitation to [event.fromHost] has been accepted.|
| [onOutgoingRequestRejected](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestRejected.html) | The PK invitation to [event.fromHost] has been rejected.|
|[onOutgoingRequestTimeout](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestTimeout.html)|Your PK invitation has been timeout|
| [onEnded](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onEnded.html) |PK invitation had been ended by [event.fromHost]|
| [onUserOffline](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onUserOffline.html) |PK host offline|
| [onUserQuited](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onUserQuited.html) |PK host quit|

### 5.2 Events of PK invitee：

|func name|description|
|-|-|
| [onIncomingRequestReceived](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingRequestReceived.html) |Received a PK invitation from [event.fromHost], with the ID [event.requestID].|
| [onIncomingRequestCancelled](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingRequestCancelled.html) | The received PK invitation has been canceled by the inviting host [event.fromHost]. |
| [onIncomingRequestTimeout](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingRequestTimeout.html) |The received PK invitation has timed out.|
| [onEnded](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onEnded.html) |PK invitation had been ended by [event.fromHost]|
| [onUserOffline](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onUserOffline.html) |PK host offline|
| [onUserQuited](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onUserQuited.html) |PK host quit|
...
|-|-|-|
|onIncomingPKBattleRequestReceived|[onIncomingRequestReceived](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingRequestReceived.html)|The requestID parameter from the event will be required when using the acceptRequest or rejectRequest functions.|
|onIncomingPKBattleRequestCancelled|[onIncomingRequestCancelled](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingPKBattleRequestCancelled.html)||
|onIncomingPKBattleRequestTimeout|[onIncomingRequestTimeout](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onIncomingRequestTimeout.html)||
|onOutgoingPKBattleRequestAccepted|[onOutgoingRequestAccepted](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestAccepted.html)||
|onOutgoingPKBattleRequestRejected|[onOutgoingRequestRejected](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestRejected.html)||
|onOutgoingPKBattleRequestTimeout|[onOutgoingRequestTimeout](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onOutgoingRequestTimeout.html)||
|onPKBattleEndedByAnotherHost|[onEnded](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoUIKitPrebuiltLiveStreamingPKEvents/onEnded.html)||
