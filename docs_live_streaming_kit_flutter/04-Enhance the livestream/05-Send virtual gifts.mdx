...
Before you begin, make sure you complete the integration by referring to the [Quick start with co-hosting](/live-streaming-kit-flutter/quick-start/quick-start-(with-cohosting)).
